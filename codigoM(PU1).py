...
advertencia_mostrada = False  # Variable global para controlar la aparición de la advertencia
...
def recibir_temperatura():
    ...
    if not advertencia_mostrada and (temperatura < limite_inferior or temperatura > limite_superior):
        mostrar_advertencia()
        reproducir_sonido()
